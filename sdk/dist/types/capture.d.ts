...
export type DataType = 'location' | 'browsing' | 'purchase' | 'social' | 'health' | 'financial' | 'preferences' | 'demographics' | 'behavioral' | 'custom';
...
export declare enum AnonymizationLevel {
    None = 0,
    Basic = 1,
    Differential = 2,
    Federated = 3
...
export declare enum LiquidityStrategy {
    Conservative = 0,
    Balanced = 1,
    Aggressive = 2,
    Custom = 3
...
export declare enum ArbitrageAction {
    Store = 0,
    Discharge = 1,
    ShiftLoad = 2,
    SellToGrid = 3
...
export declare enum IntroOutcome {
    Connected = 0,
    DealClosed = 1,
    Declined = 2,
    Expired = 3
...
/** Vote on a claim */
export declare enum ClaimVoteType {
    Approve = 0,
    Reject = 1,
    Abstain = 2
}
